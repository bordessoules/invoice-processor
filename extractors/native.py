"""Skill d'extraction via le texte brut du PDF (route rapide)."""
...
_SYSTEM = (
    "Tu extrais des factures et documents commerciaux. Reponds UNIQUEMENT en JSON.\n"
    ...
    "\n"
    "REGLES STRICTES :\n"
    "1. Si un champ n'est pas visible dans le document, mets EXACTEMENT null. Ne l'invente JAMAIS.\n"
    "2. prix_unitaire_ht doit etre le prix HORS TAXE, pas TTC.\n"
    "3. Liste chaque produit/service distinct dans 'lignes'. NE PAS agreger en categories generiques comme 'Vos abonnements, forfaits et options'.\n"
...
def extract_from_text(text: str, filename: str, model: str = None, sampling: dict = None) -> Invoice:
    ...
    invoice.raw_text = text[:2000]
    invoice.extraction_method = "native_text"
